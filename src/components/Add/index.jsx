...
import { Box, Fab, Tooltip, Modal, styled, Typography, TextField, ButtonGroup, Button } from "@mui/material";
      ...
      <>
         ...
         <StyledModal open={open} onClose={handleClose}>
            <Box sx={StyledBox}>
               ...
               <TextField fullWidth id="stanwdard-basic" label={`What's on your mind?`} variant="standard" multiline rows={3} />
