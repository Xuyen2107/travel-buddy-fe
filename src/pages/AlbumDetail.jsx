   ...
   const data = [
      {
         ...
         images: [
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/k7iwvmrp1rafuews79ia.jpg",
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/ahxstciq8wmq5ehnvvoy.jpg",
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/xeilgavx2zburp4kznkl.jpg",
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/k7iwvmrp1rafuews79ia.jpg",
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/ahxstciq8wmq5ehnvvoy.jpg",
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/xeilgavx2zburp4kznkl.jpg",
            "https://res.cloudinary.com/dcgytjpvn/image/upload/v1698660633/Travel_Buddy/k7iwvmrp1rafuews79ia.jpg",
         ...
         <Card variant="outlined">
            ...
            <Box sx={{ flexGrow: 1, margin: 2 }}>
               <ImageList variant="masonry" cols={3} gap={8}>
                  {vacation.images &&
                     vacation.images.map((image, index) => (
